# Generated by Django 4.2.11 on 2024-03-22 15:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(validators=[django.core.validators.MinValueValidator(limit_value=datetime.date(2024, 3, 22))])),
            ],
        ),
        migrations.CreateModel(
            name='Table',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('booking_table', models.IntegerField(choices=[(1, 'Table 1'), (2, 'Table 2'), (3, 'Table 3'), (4, 'Table 4'), (5, 'Table 5'), (6, 'Table 6'), (7, 'Table 7'), (8, 'Table 8'), (9, 'Table 9'), (10, 'Table 10'), (11, 'Table 11'), (12, 'Table 12'), (13, 'Table 13'), (14, 'Table 14')])),
            ],
        ),
        migrations.CreateModel(
            name='TimeSlot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking_date', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booking.date')),
